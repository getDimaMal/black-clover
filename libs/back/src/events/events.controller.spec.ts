...
describe('EventsController', () => {
  ...
  describe('create', () => {
    it('should call eventsService.crete and return the result', async () => {
  ...
  describe('update', () => {
    it('should call eventsService.update and return the result', async () => {
      ...
      const result = await eventsController.update(eventId, createEvent);

      expect(eventsService.update).toHaveBeenCalledWith(eventId, createEvent);
      expect(result).toEqual(event);
    });
  });
});
